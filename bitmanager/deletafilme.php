...
<body>
    <div class="container">
        <div class="form-container">
            <h1 class="title">Excluir Filme</h1>
            <form action="deletafilme.php" method="POST">
                <div class="checkbox-container">
                    <input type="checkbox" name="confirma" value="sim" id="chkbox" onclick="mudatexto()">
                    <label for="chkbox" class="confirm-label">Marque para confirmar a exclusão do Filme: </label>
