...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    s_dev_produto = '$desenvolvedor',
    s_ativ_produto = '$ativacao',
...
<body>
    <div id="cad">
        <div class="w3-container form-container">
            <h1>Alterar Jogo</h1>
            <form action="alterajogo.php" method="POST" class="w3-container">
                ...
                <textarea name="descricao" id="descricao" maxlength="100" required><?= $descricao ?></textarea>
        ...
        <div class="w3-container form-container">
            ...
            <input type="text" name="desenvolvedor" id="desenvolvedor" maxlength="50" value="<?= $desenvolvedor ?>" required>

            <label for="ativacao">Chave de Ativação:</label>
            <input type="text" name="ativacao" id="ativacao" maxlength="30" value="<?= $ativacao ?>" required>
