...
<body>
    <div class="container">
        <div class="form-container">
            <h1 class="title">Excluir Jogo</h1>
            <form action="deletajogo.php" method="POST">
                <div class="checkbox-container">
                    <input type="checkbox" name="confirma" value="sim" id="chkbox" onclick="mudatexto()">
                    <label for="chkbox" class="confirm-label">Marque para confirmar a exclusão do Jogo: </label>
